...
import br.com.senac.integrador.escola.modelos.auxiliares.Tags;
...
public abstract class SQLManager {
    ...
    public static void cadastrar(Pessoa pessoa) throws SQLException {
        ...
        System.out.println(titular.getDataNascimento().toString());
        ...
        String sqlstate = String.format(
                ...
                "(%d, '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', DATE '"+titular.getDataNascimento().toString()+"')",
    ...
    public static void cadastrar(Estudante estudante) throws SQLException {
        ...
        String sqlState = String.format("INSERT INTO estudante " +
                "(idPessoa, dataInscricao, nomeResponsavel, trabalha, idLogin, escolaridade, periodo) VALUES " +
                "(%d, '%s', '%s', '%s', %d, '%s', '%s')", 
                estudante.getIdPessoa(), estudante.getDataInscricao(), estudante.getNomeResponsavel(), trabalha, estudante.getIdLogin(), estudante.getEscolaridade().name(), estudante.getPeriodo().name());
        statement.execute(sqlState);
    ...
    public static Pessoa buscarPessoa(Fator fator, String valor) throws SQLException {
        ...
        while(r.next()) {
            ...
            Date date = r.getDate(Tags.DATANASCIMENTO.name());
